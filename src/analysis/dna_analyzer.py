...
class DNAAnalyzer:
    ...
    def analyze(self, filename):
        ...
        ncbi_data = self._ncbi_dataframe_generator.get_dataframe_of_data(merged_dna_data_with_studied_rsids, allow_download=False, force_regenerate_dataframe=True)
